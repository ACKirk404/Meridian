...
System messages, NASA-style Go calls, harness health, proof status, worker/session state, artifacts, review gates, and instrumentation Prime wants visible. This is also a prompt window where Scott can respond directly to the artifact, plan, proof, comparison, or gate Prime is presenting.
