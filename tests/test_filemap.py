...
_REQUIRED_PATHS = [
    ...
    "meridian_core/review_console_snapshot.py",
    ...
    "docs/v2-continuation-handoff-20260607.md",
    ...
    "meridian_core/federation_horizon_snapshot.py",
    ...
    "docs/live-build-active-polling-contract.md",
    "docs/prime-queue-runway-policy.md",
    "docs/queue-runway-runtime-object.md",
    "docs/v2-orchestrator-handoff-20260601.md",
    "docs/v2-orchestrator-transition-ledger.md",
    ...
    "bifrost/static/media/spark-center-final.png",
    ...
    "meridian_core/decisions.py",
    "meridian_core/events.py",
    "meridian_core/injections.py",
    "meridian_core/lane_state.py",
    "meridian_core/sample_state.py",
